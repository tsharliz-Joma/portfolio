    ...
    <div>
      ...
      <div className="absolute top-1/2 left-0 hidden sm:block transform -translate-y-1/2 z-10">
        <button
          ...
          className="p-2 relative bg-transparent hover:left-[-2px] text-white rounded-full shadow-lg">
          &#8592;
        </button>
      </div>
      <div className="absolute top-1/2 right-0  hidden sm:block  transform -translate-y-1/2 z-10">
        <button
          ...
          className="p-2 relative hover:right-[-2px] bg-transparent text-white rounded-full shadow-lg">
          &#8594;
        </button>
      </div>
    </div>
