...
const AboutCard = forwardRef(({ content, className, direction, cta, ...props }, ref) => {
  ...
  return (
    <div ref={ref} style={{ backgroundColor: props.bg }} className={cn(`fixed flex items-end justify-start w-full min-h-full`, className)}>
      <Button className="font-inter cursor-pointer bg-transparent focus:outline-none flex items-center justify-center w-fit h-fit pb-1" onPress={onOpen}>
