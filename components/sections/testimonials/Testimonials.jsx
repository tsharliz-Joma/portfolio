...
import TestimonialsData from "./Testimonials.content.json";
                        ...
                        <div className="flex justify-center items-center py-2">
                          {Number(item?.rating) < 6 &&
                            Array.from(
                              ...
                              (_, index) => (
                                <div key={index}>
                                  <svg width="20px" height="20px" viewBox="0 0 24.00 24.00" fill="yellow" xmlns="http://www.w3.org/2000/svg" stroke="yellow">
